...
for task in todo:
    if task.lower() == "coffee break":
        print("It's time for coffee break!")
        break
...
for animal, n in dict1.items():
    if n == "land":
        print(f"{animal} lives in {n}")
...
print("Number of legs (directly from object):", animal.leg_count)
